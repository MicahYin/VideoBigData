    ...
    <div id="main">
        ...
        <div class="main_right fr">
            ...
            <div class="xrss_shishi">
                ...
                <div class=" main_right_c swiper-container">
                    <ul class="swiper-wrapper">
                        ...
                        <li  class="swiper-slide"><img src="${pageContext.request.contextPath}/images/02.jpg"></li>
                        <li  class="swiper-slide"><img src="${pageContext.request.contextPath}/images/03.jpg"></li>
                        <li  class="swiper-slide"><img src="${pageContext.request.contextPath}/images/01.jpg"></li>
                        <li  class="swiper-slide"><img src="${pageContext.request.contextPath}/images/02.jpg"></li>
                        <li  class="swiper-slide"><img src="${pageContext.request.contextPath}/images/03.jpg"></li>
                        <li  class="swiper-slide"><img src="${pageContext.request.contextPath}/images/01.jpg"></li>
            ...
            <div class="xrss_shishi cheliang">
                ...
                <div class=" main_right_c swiper-container">
                    <ul class="swiper-wrapper">
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/04.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/05.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/06.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/04.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/05.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/06.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/04.jpg"></li>
            ...
            <div class="xrss_shishi">
                ...
                <div class=" main_right_c swiper-container">
                    ...
                    <ul class="swiper-wrapper">
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/07.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/08.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/09.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/07.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/08.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/09.jpg"></li>
                        <li class="swiper-slide"><img src="${pageContext.request.contextPath}/images/07.jpg"></li>
