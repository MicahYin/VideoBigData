    ...
    <div id="main">
        ...
        <div class="car_main">
            <div class="car_main_header">
                <div class="car_main_header_bt font16"><b>日流量统计</b></div>
            </div>
            <form action="" method="post" class="car_main_content margin-60 clearfix">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><span>213</span></td>
                        <td><span>123</span></td>
                        <td><span>4545</span></td>
                        <td><span>34</span></td>
                        <td><span>6443</span></td>
                        <td><span>34</span></td>
                        <td><span>13</span></td>
                        <td><span>0</span></td>
                ...
                <div class="count_picurte clearfix">
                    <span class="title">日流量图</span>
                    <img src="${pageContext.request.contextPath}/images/day_flow_img.png" width="1160">
                </div>
            </form>
